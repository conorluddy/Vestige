...
pub use memory::{
    ...
    project_detail, rank_hits, sanitize_fts_query, truncate_at_utf8_boundary, FetchedMemory,
    HybridOpts, HybridScore, ListFilter, MemoryBundle, MemoryCard, MemoryDetail, NewMemory,
    NewSource, RepresentationRow, ScoredCard, SearchFilter, SearchHit, SearchMode, SemanticHit,
