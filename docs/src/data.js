...
const VESTIGE = {
  ...
  roadmap: [
    ...
    { v: 'V0.6', title: 'Memory lifecycle',     status: 'now',     items: 'epic #127 — vestige revise (in-place edit, keeps handle) · supersede (soft-delete + link, why lineage) · usage counters (recall_count/expand_count/last_recalled_at) · usage-aware ranking + context-pack ordering · hybrid-default recall · semantic dedup on propose (matched_via: lexical/semantic/both) · next: vestige review hygiene queue (#135), dogfood cleanup + roadmap shift (#136)' },
    { v: 'V0.7', title: 'Directives',           status: 'planned', items: 'pluggable prompt blocks (.vestige/directives.md) · project-scoped allow/deny rules · injected into auto-memorise + heartbeat ingestion' },
    { v: 'V0.8', title: 'REM consolidation',    status: 'planned', items: 'Review · Evaluate · Merge — project summary refresh · clustering · review-first consolidation' },
    { v: 'V0.9', title: 'Global preferences',   status: 'planned', items: '~/.vestige/global.sqlite · explicit include · project wins' },
    { v: 'V0.10',title: 'Federation',           status: 'planned', items: 'project registry · cross-project search · related memories' },
    { v: 'V0.11',title: 'Memory dashboard (GUI)', status: 'planned', items: 'graphical browser over the daemon\'s local API · web-served default · Swift / Electron variants TBD' },
